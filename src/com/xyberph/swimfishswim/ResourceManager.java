...
public class ResourceManager {
	...
	public void loadFont() {
		...
		font = FontFactory.create(activity.getFontManager(), activity.getTextureManager(), 256, 256, Typeface.create("SansPosterBold.ttf", Typeface.BOLD), 50,
				true, Color.BLACK);
		//font = FontFactory.createFromAsset(activity.getFontManager(), activity.getTextureManager(), 256, 256, TextureOptions.BILINEAR, activity.getAssets(), "SansPosterBold.ttf", 45, true, Color.BLACK);
	...
	*/
	...
	public void loadGameResources() {
		...
		repeatingGroundAtlas = new BitmapTextureAtlas(activity.getTextureManager(), 1024, 270, TextureOptions.REPEATING_BILINEAR_PREMULTIPLYALPHA);
		repeatingGroundRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(repeatingGroundAtlas, activity, "ground_1.png", 0, 0);
		...
		dandelionRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(
				gameObjectsAtlas, activity.getAssets(), "fish_tiled.png", 4, 1);
